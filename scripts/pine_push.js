...
const set = (await c.Runtime.evaluate({
  expression: `(function(){var cs=Array.prototype.slice.call(document.querySelectorAll(".monaco-editor.pine-editor-monaco"));var c=cs.find(function(e){return e.offsetParent!==null})||cs[0];if(!c)return false;var el=c;var fk;for(var i=0;i<20;i++){if(!el)break;fk=Object.keys(el).find(function(k){return k.startsWith("__reactFiber$")});if(fk)break;el=el.parentElement}if(!fk)return false;var cur=el[fk];for(var d=0;d<15;d++){if(!cur)break;if(cur.memoizedProps&&cur.memoizedProps.value&&cur.memoizedProps.value.monacoEnv){var env=cur.memoizedProps.value.monacoEnv;if(env.editor&&typeof env.editor.getEditors==="function"){var eds=env.editor.getEditors();var ed=eds.find(function(x){var n=typeof x.getDomNode==="function"?x.getDomNode():null;return n&&n.offsetParent!==null&&(n===c||n.contains(c)||c.contains(n))})||eds.find(function(x){var n=typeof x.getDomNode==="function"?x.getDomNode():null;return n&&n.offsetParent!==null})||eds[eds.length-1];if(ed){ed.setValue(${escaped});return true}}}cur=cur.return}return false})()`,
  returnByValue: true,
})).result?.value;
...
const errors = (await c.Runtime.evaluate({
  expression: '(function(){var cs=Array.prototype.slice.call(document.querySelectorAll(".monaco-editor.pine-editor-monaco"));var c=cs.find(function(e){return e.offsetParent!==null})||cs[0];if(!c)return[];var el=c;var fk;for(var i=0;i<20;i++){if(!el)break;fk=Object.keys(el).find(function(k){return k.startsWith("__reactFiber$")});if(fk)break;el=el.parentElement}if(!fk)return[];var cur=el[fk];for(var d=0;d<15;d++){if(!cur)break;if(cur.memoizedProps&&cur.memoizedProps.value&&cur.memoizedProps.value.monacoEnv){var env=cur.memoizedProps.value.monacoEnv;if(env.editor&&typeof env.editor.getEditors==="function"){var eds=env.editor.getEditors();var ed=eds.find(function(x){var n=typeof x.getDomNode==="function"?x.getDomNode():null;return n&&n.offsetParent!==null&&(n===c||n.contains(c)||c.contains(n))})||eds.find(function(x){var n=typeof x.getDomNode==="function"?x.getDomNode():null;return n&&n.offsetParent!==null})||eds[eds.length-1];if(ed){var model=ed.getModel();var markers=env.editor.getModelMarkers({resource:model.uri});return markers.map(function(m){return{line:m.startLineNumber,msg:m.message}})}}}cur=cur.return}return[]})()',
  returnByValue: true,
})).result?.value || [];
